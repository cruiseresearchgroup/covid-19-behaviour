...
def daily_timeline(data, day, categories=None, SAVE=False):
    """
    this code here may be interesting for the purpose of processing data from
    a list of events to columns with times and rows with app categories
    """
...
def segment(filename, categories_filename,draw_only=False):
    ...
    The category file is handwritten, and provided in categories.csv
